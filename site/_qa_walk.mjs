...
assert(html.includes('app.js?v=v2-live-5') || /app\.js\?v=v2-live-5/.test(html), 'asset version bumped');
assert(src.includes("ASSET_VERSION = 'v2-live-5'"), 'ASSET_VERSION matches index.html');
