...
assert(html.includes('app.js?v=v2-live-6') || /app\.js\?v=v2-live-6/.test(html), 'asset version bumped');
assert(src.includes("ASSET_VERSION = 'v2-live-6'"), 'ASSET_VERSION matches index.html');
