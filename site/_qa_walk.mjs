...
assert(html.includes('app.js?v=v2-live-7') || /app\.js\?v=v2-live-7/.test(html), 'asset version bumped');
assert(src.includes("ASSET_VERSION = 'v2-live-7'"), 'ASSET_VERSION matches index.html');
